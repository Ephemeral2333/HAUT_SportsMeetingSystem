            ...
            <div class="box box-primary" id="display" style="display: none">
                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <!--工具栏/-->
                        <!--数据列表-->
                        <form id="selection" action="${pageContext.request.contextPath}/borrow/deleteById"
                              method="post">
                            <!--数据列表-->
                            <table id="dataList"
...
<script>
    ...
    function deleteBorrowById(id) {
        if (confirm("您确定要删除吗？")) {
            location.href = '${pageContext.request.contextPath}/borrow/deleteById?id=' + id;
            alert("删除成功");
            location.href = '${pageContext.request.contextPath}/Equipment/BorrowCondition.jsp';
        }
    }
