...
<%@ page import="org.haut.entity.Sportmeeting" %>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
<jsp:useBean id="s" class="org.haut.entity.Sportmeeting" scope="page" />
<%
  s.findAll();
%>
<html>
        ...
        <div class="box-body">
          <div class="table-box">
              <table id="dataList"
                ...
                <tbody>
<%--                运动会开幕信息列表--%>
                <c:forEach items="${s.sportmeetingList}" var="spormeeting" varStatus="status">
                  <tr>
...
<%--                      详情--%>
                      <button type="button" class="btn bg-olive btn-xs "
                              onclick="location.href='${pageContext.request.contextPath}/Detail/OpenInformationDetail.jsp?sId=${spormeeting.SId}'">
                        详情
                      </button>
                    </td>
                  </tr>
