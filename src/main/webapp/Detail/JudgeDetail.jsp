  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="${pageContext.request.contextPath}/People/JudgeList.jsp"> 裁判信息</a></li>
        <li class="active">裁判信息详情</li>
      </ol>
    </section>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="tab-teacher">
                <div class="row data-type">
                  ...
                  <div class="col-sm-2 title">裁判号</div>
