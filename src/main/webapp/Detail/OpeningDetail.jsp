...
<%
    ...
    sportmeeting.selectSportmeetingById(Integer.parseInt(id));
%>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="OpeningDetail.jsp"> 开幕信息管理</a></li>
                            ...
                            <div class="tab-pane active" id="tab-broadcast">
                                <form id="selection1"
                                    ...
                                    <table id="dataList1" class="table table-bordered table-striped table-hover dataTable">
                                        ...
                                        <c:forEach items="${sportmeeting.broadcast}" var="broadcast">
                                            <tr>
                            ...
                            <div class="tab-pane " id="tab-event">
                                <form id="selection2" action="" method="post">
                                    <table id="dataList2"
                                        ...
                                        <c:forEach items="${sportmeeting.eventList}" var="event">
                                            <tr>
                            ...
                            <div class="tab-pane " id="tab-matches">
                                <form id="selection3" action=""
                                    ...
                                    <table id="dataList3"
                                        ...
                                        <c:forEach items="${sportmeeting.matchesList}" var="matches">
                                            <tr>
