...
public interface ClassesMapper {
    ...
    @Results(value = {
            ...
            @Result(column = "c_headmasterid", property = "teacher", one = @One(select = "org.haut.mapper.TeacherMapper.selectByPK", fetchType = FetchType.EAGER)),
            @Result(column = "c_deptid", property = "department", one = @One(select = "org.haut.mapper.DepartmentMapper.selectByPK", fetchType = FetchType.EAGER))
    })
    ...
    @Results(id = "classMap", value = {
            ...
            @Result(column = "c_headmasterid", property = "teacher", one = @One(select = "org.haut.mapper.TeacherMapper.selectByPK", fetchType = FetchType.LAZY)),
            @Result(column = "c_deptid", property = "department", one = @One(select = "org.haut.mapper.DepartmentMapper.selectByPK", fetchType = FetchType.LAZY))
    })
