...
public interface DepartmentMapper {
    ...
    @Results(value = {
            ...
            @Result(column = "d_deanid", property = "teacher", one = @One(select = "org.haut.mapper.TeacherMapper.selectByPK", fetchType = FetchType.EAGER))
    })
    ...
    @Results(value = {
            ...
            @Result(column = "d_deanid", property = "teacher", one = @One(select = "org.haut.mapper.TeacherMapper.selectByPK", fetchType = FetchType.LAZY))
    })
